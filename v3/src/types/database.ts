...
export type DatabaseAppRole =
  "student" | "parent" | "teacher" | "admin" | "direction";
export type DatabaseAccountStatus =
...
export type DatabaseLearningProgressStatus =
  "not_started" | "in_progress" | "mastered" | "review";
export type DatabaseAssignmentStatus =
  "todo" | "in_progress" | "submitted" | "corrected";
export type DatabaseAttendanceStatus =
  "present" | "absent" | "late" | "excused";
export type DatabaseTeacherSessionStatus =
  "in_progress" | "report_pending" | "completed" | "cancelled";
export type DatabaseRecitationAppreciation =
  | "excellent"
  | "very_good"
  | "good"
  | "acceptable"
  ...
  | "weak"
  | "insufficient";
export type DatabaseWorkflowStatus =
  | "draft"
  | "submitted"
  | "seen"
  | "in_review"
  ...
  | "resolved"
  | "cancelled";
export type DatabaseTeacherRequestKind =
  | "absence"
  | "late"
  | "leave"
  | "salary_problem"
...
export type DatabaseNotificationCategory =
  | "message"
  | "request"
  | "assignment"
  | "learning"
...
export type DatabaseContactLabel =
  "personal" | "professional" | "parent" | "emergency" | "other";
export type DatabaseContactVerificationStatus =
  "unverified" | "pending" | "verified" | "disabled";
export type DatabaseNotificationPriority =
  "low" | "normal" | "important" | "urgent";
export type DatabaseNotificationChannel =
  "in_app" | "push" | "email" | "sms" | "whatsapp";
export type DatabaseNotificationDeliveryStatus =
  | "pending"
  | "processing"
  | "sent"
  | "delivered"
...
type PublicCategoryTranslationRow = {
  category_id: string;
  locale: DatabasePublicLocale;
  name: string;
};
type PublicProgramRow = {
  ...
  school_id: string;
  slug: string;
  status: DatabasePublicationStatus;
...
type PublicScheduleTranslationRow = {
  schedule_id: string;
  locale: DatabasePublicLocale;
  title: string;
  notes: string | null;
...
type QuranAudioTrackRow = {
  id: string;
  reciter_key: string;
  reciter_name: string;
  riwaya: string;
  url_template: string;
  fallback_url_template: string | null;
  active: boolean;
  created_at: string;
};
...
type SchoolAnnouncementRow = {
  ...
  title: string;
  body: string;
  audience: "all" | "students" | "families" | "teachers";
  published_at: string;
...
type StudentSurahProgressRow = {
  student_id: string;
  surah_number: number;
  status: DatabaseLearningProgressStatus;
...
type AssignmentSubmissionRow = {
  ...
  student_id: string;
  status: DatabaseAssignmentStatus;
...
type ValidatedLearningContentRow = {
  id: string;
  school_id: string | null;
  kind: string;
  prompt: string;
...
type RecitationAttemptRow = {
  id: string;
  student_id: string;
  surah_number: number;
  verse_from: number;
  verse_to: number;
  status: "recording" | "processing" | "completed" | "inconclusive" | "failed";
...
type RecitationResultRow = {
  ...
  acoustic_tajwid_status: "not_evaluated";
  analysed_at: string;
};
type RecitationErrorRow = {
  id: number;
  attempt_id: string;
...
type UserNotificationRow = {
  ...
  read_at: string | null;
  created_at: string;
  category: DatabaseNotificationCategory;
  entity_type: string | null;
  entity_id: string | null;
  dedup_key: string | null;
  event_id: string | null;
  priority: DatabaseNotificationPriority;
  archived_at: string | null;
  expires_at: string | null;
};
...
type TeacherSessionRunRow = {
  id: string;
  course_session_id: string;
  class_id: string;
  teacher_id: string;
  status: DatabaseTeacherSessionStatus;
  started_at: string;
  ended_at: string | null;
  created_at: string;
};
type TeacherSessionStudentRow = {
  run_id: string;
  student_id: string;
  attendance: DatabaseAttendanceStatus;
  minutes_late: number;
  processed_at: string | null;
  behavior: "excellent" | "good" | "mixed" | "difficult" | null;
  difficulty_flags: Json;
  teacher_note: string | null;
  updated_at: string;
};
type TeacherRecitationRow = {
  id: string;
  run_id: string;
  student_id: string;
  surah_number: number;
  verse_from: number;
  verse_to: number;
  appreciation: DatabaseRecitationAppreciation;
  comment: string | null;
  recorded_by: string;
  recorded_at: string;
};
type TeacherSessionReportRow = {
  id: string;
  run_id: string;
  teacher_id: string;
  class_id: string;
  status: DatabaseWorkflowStatus;
  program_status: "completed" | "partial" | "not_completed" | null;
  present_count: number;
  absent_count: number;
  late_count: number;
  behavior: "excellent" | "good" | "mixed" | "difficult" | null;
  difficulty_flags: Json;
  follow_up_students: Json;
  incident: boolean;
  incident_summary: string | null;
  equipment: "ready" | "missing" | "damaged" | null;
...
type TeacherRequestRow = {
  ...
  school_id: string;
  teacher_id: string;
  kind: DatabaseTeacherRequestKind;
  status: DatabaseWorkflowStatus;
  title: string;
  details: string | null;
...
type TeacherSalaryRecordRow = {
  ...
  net_amount: number;
  currency: string;
  status: "pending" | "paid" | "issue_reported" | "resolved";
  paid_at: string | null;
  note: string | null;
...
type StudentDigitalFileRow = {
  ...
  guardian_identity_received: boolean;
...
type StaffProfileRow = {
  ...
  employment_status: DatabaseMembershipStatus;
  updated_at: string;
};
type SchoolIncidentRow = {
  id: string;
  school_id: string;
  student_id: string | null;
...
type StudentPaymentRow = {
  ...
  currency: string;
  paid_on: string;
  status: "paid" | "partial" | "exempt" | "cancelled";
  note: string | null;
  finance_transaction_id: string | null;
  created_by: string;
  created_at: string;
...
type AdminSchoolSettingRow = {
  school_id: string;
  finance_alert_threshold: number;
  updated_by: string;
  updated_at: string;
};
type SchoolDocumentRow = {
  ...
  visible_to_related_user: boolean;
  uploaded_by: string;
  created_at: string;
};
type AdminPermissionGrantRow = {
  user_id: string;
  permission:
    | "people"
    | "academics"
...
type AdminTaskRow = {
  ...
  entity_type: string | null;
  entity_id: string | null;
  status: DatabaseAdminTaskStatus;
...
type ServiceRequestRow = {
  ...
  kind: DatabaseServiceRequestKind;
  status: DatabaseServiceRequestStatus;
  priority: DatabaseRequestPriority;
  title: string;
  details: string | null;
  assigned_to: string | null;
  due_at: string | null;
...
type ServiceRequestEventRow = {
  ...
  actor_id: string;
  event_kind: string;
  from_status: DatabaseServiceRequestStatus | null;
  to_status: DatabaseServiceRequestStatus | null;
  note: string | null;
  created_at: string;
};
...
type UserContactLinkRow = {
  id: string;
  contact_point_id: string;
  user_id: string;
  label: DatabaseContactLabel;
...
type NotificationPolicyRow = {
  ...
  school_id: string;
  event_type: string;
  minimum_priority: DatabaseNotificationPriority;
  mandatory_channels: DatabaseNotificationChannel[];
...
type NotificationTemplateRow = {
  ...
  event_type: string;
  locale: DatabasePublicLocale;
  channel: DatabaseNotificationChannel;
...
type NotificationCampaignRow = {
  ...
  href: string | null;
  audience: Json;
  channels: DatabaseNotificationChannel[];
  priority: DatabaseNotificationPriority;
  locale: DatabasePublicLocale;
  status:
    | "draft"
...
type NotificationDeliveryRow = {
  ...
  status: DatabaseNotificationDeliveryStatus;
...
type ContactVerificationChallengeRow = {
  id: string;
  contact_point_id: string;
  user_id: string;
  code_digest: string;
...
export type Database = {
  public: {
    Tables: {
      student_learning_sessions: ReadonlyTable<{
        student_id: string;
        learning_key: string;
        state: Json;
        version: number;
      ...
      student_payments: ReadonlyTable<StudentPaymentRow>;
      admin_school_settings: ReadonlyTable<AdminSchoolSettingRow>;
    ...
    Functions: {
      ...
      update_own_assignment: {
        Args: {
          ...
          target_status: DatabaseAssignmentStatus;
      ...
      teacher_start_session: {
        Args: { target_course_session_id: string };
        Returns: string;
      };
      teacher_save_attendance: {
        Args: { target_run_id: string; attendance_rows: Json };
        Returns: undefined;
      };
      teacher_record_student_work: {
        Args: {
          ...
          target_verse_from: number;
          target_verse_to: number;
          target_appreciation: DatabaseRecitationAppreciation;
          target_comment: string;
          target_behavior: "excellent" | "good" | "mixed" | "difficult";
          target_difficulties: Json;
          target_create_goal: boolean;
          target_goal_surah: number;
          target_goal_from: number;
          target_goal_to: number;
          target_create_assignment: boolean;
          target_assignment_due: string | null;
        };
        Returns: string;
      };
      teacher_open_session_report: {
      ...
      teacher_submit_session_report: {
        Args: {
          ...
          target_program_status: "completed" | "partial" | "not_completed";
          target_behavior: "excellent" | "good" | "mixed" | "difficult";
          target_difficulties: Json;
          target_follow_up_students: Json;
          target_incident: boolean;
          target_incident_summary: string;
          target_equipment: "ready" | "missing" | "damaged";
          target_equipment_details: string;
      ...
      teacher_create_request: {
        Args: {
          target_kind: DatabaseTeacherRequestKind;
          target_title: string;
      ...
      teacher_start_class_session: {
        Args: { target_class_id: string };
        Returns: string;
      };
      teacher_can_access_conversation: {
        Args: { target_conversation_id: string };
        Returns: boolean;
      };
      admin_review_teacher_request: {
        Args: {
          target_request_id: string;
          target_status: DatabaseWorkflowStatus;
          target_response?: string | null;
        };
        Returns: undefined;
      };
      admin_resolve_task: {
        Args: {
          ...
          target_status: DatabaseAdminTaskStatus;
        };
        Returns: undefined;
      };
      ...
      admin_create_command_record: {
        Args: { target_kind: string; payload: Json };
        Returns: string;
      };
      admin_update_person: {
        Args: { target_user_id: string; payload: Json };
        Returns: undefined;
      };
      admin_set_student_relations: {
        Args: {
          target_student_id: string;
      ...
      admin_set_teacher_classes: {
        Args: { target_teacher_id: string; target_class_ids: string[] };
        Returns: undefined;
      };
      admin_record_student_payment: {
        Args: {
          target_student_id: string;
      ...
      admin_set_finance_threshold: {
        Args: { target_school_id: string; target_amount: number };
        Returns: undefined;
      };
      admin_update_login_alias: {
        Args: {
          target_user_id: string;
          target_login_alias: string;
      ...
      create_direct_conversation: {
        Args: { target_user_id: string; target_subject: string };
        Returns: string;
      };
      ...
      archive_conversation: {
        Args: { target_conversation_id: string; target_archived?: boolean };
        Returns: undefined;
      };
      create_service_request: {
        Args: {
          target_kind: DatabaseServiceRequestKind;
          target_title: string;
          target_details?: string | null;
          target_priority?: DatabaseRequestPriority;
      ...
      update_service_request: {
        Args: {
          target_request_id: string;
          target_status: DatabaseServiceRequestStatus;
          target_note?: string | null;
      ...
      set_notification_preference: {
        Args: {
          target_category: DatabaseNotificationCategory;
          target_in_app: boolean;
          target_browser: boolean;
          target_realtime: boolean;
        };
        Returns: undefined;
      };
      list_my_contacts: {
      ...
      save_user_contact: {
        Args: {
          target_user_id: string;
          target_kind: DatabaseContactKind;
          target_normalized_value: string;
          target_display_value: string;
          target_country_code: string;
          target_label: DatabaseContactLabel;
          target_is_primary?: boolean;
          target_notification_enabled?: boolean;
          target_use_for_login?: boolean;
          target_use_for_notifications?: boolean;
          target_is_emergency?: boolean;
      ...
      set_notification_channels: {
        Args: {
          ...
          target_sms: boolean;
          target_whatsapp: boolean;
          target_digest_frequency?: string;
          target_quiet_start?: string | null;
          target_quiet_end?: string | null;
        };
        Returns: undefined;
      };
      register_user_device: {
        Args: {
          ...
          target_push_subscription_id?: string | null;
        };
        Returns: string;
      };
      remove_user_device: {
      ...
      archive_notification: {
        Args: { target_notification_id: string; target_archived?: boolean };
        Returns: undefined;
      };
      estimate_notification_audience: {
        Args: { target_school_id: string; target_audience: Json };
        Returns: number;
      };
      create_notification_campaign: {
        Args: {
          ...
          target_channels: DatabaseNotificationChannel[];
          target_priority: DatabaseNotificationPriority;
          target_locale?: DatabasePublicLocale;
      ...
      finish_notification_delivery: {
        Args: {
          ...
          target_error_detail?: string | null;
      ...
      cancel_contact_verification_challenge: {
        Args: {
      ...
      verify_contact_verification_challenge: {
        Args: {
          target_user_id: string;
          target_link_id: string;
          target_code_digest: string;
      ...
      auth_rate_limit_allowed: {
        Args: { target_keys: string[] };
        Returns: boolean;
      };
      record_auth_rate_limit: {
        Args: { target_keys: string[]; target_success: boolean };
        Returns: undefined;
      };
      has_permission: {
      ...
      claim_offline_mutation: {
        Args: { target_id: string; target_kind: string };
        Returns: "claimed" | "completed" | "busy";
      };
      finish_offline_mutation: {
        Args: {
          target_id: string;
          target_success: boolean;
          target_error_code?: string | null;
