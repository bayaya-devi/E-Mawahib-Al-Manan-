...
export const publicCopy: Record<PublicLocale, Copy> = {
  ar: {
    brand: "دار القرآن والحديث", association: "جمعية مواهب المنان", login: "دخول المنصة", menu: "القائمة", language: "اللغة",
    ...
    hero: { kicker: "جمعية مواهب المنان · عين العودة", title: "دار القرآن والحديث", copy: "فضاء لتعليم القرآن الكريم بقواعد التجويد، وتعليم السنة النبوية والقيم الإسلامية للرجال والنساء والأطفال ابتداء من خمس سنوات.", primary: "معلومات التسجيل", secondary: "اكتشف البرامج", trust: "تعليم متدرج · تجويد · سنة وقيم" },
    about: { eyebrow: "التعريف بالجمعية", title: "تعليم القرآن في بيئة تربوية هادئة ومنظمة", paragraphs: ["تستقبل جمعية مواهب المنان بعين العودة الرجال والنساء والأطفال في دار القرآن والحديث، لتعلم كتاب الله تعالى والقراءة الصحيحة بقواعد التجويد.", "يسير البرنامج خطوة بخطوة، ويجمع بين تعلم القرآن الكريم والسنة النبوية والقيم الإسلامية."], caption: "فضاء مهيأ للتعلم والحفظ والمراجعة" },
    ...
    contact: { eyebrow: "تواصل معنا", title: "مرحبا بكم في عين العودة", copy: "للاستفسار عن التسجيل والبرامج، تواصلوا مباشرة مع إدارة الجمعية.", phone: "الهاتف", address: "العنوان", map: "فتح الخريطة" }, footer: "جمعية مواهب المنان · دار القرآن والحديث",
  },
  fr: {
    brand: "Dar Al-Qur’an wal-Hadith", association: "Association Mawahib Al Manan", login: "Se connecter", menu: "Menu", language: "Langue",
    ...
    contact: { eyebrow: "Contact", title: "Bienvenue à Ain El Aouda", copy: "Pour toute question sur les inscriptions ou les programmes, contactez directement l’administration.", phone: "Téléphone", address: "Adresse", map: "Ouvrir la carte" }, footer: "Association Mawahib Al Manan · Dar Al-Qur’an wal-Hadith",
  },
  en: {
    brand: "Dar Al-Qur’an wal-Hadith", association: "Mawahib Al Manan Association", login: "Sign in", menu: "Menu", language: "Language",
    ...
    contact: { eyebrow: "Contact", title: "Welcome to Ain El Aouda", copy: "For registration and program enquiries, contact the association administration directly.", phone: "Telephone", address: "Address", map: "Open map" }, footer: "Mawahib Al Manan Association · Dar Al-Qur’an wal-Hadith",
  },
  amz: {
    ...
    hero: { kicker: "ⵜⴰⵎⵓⵏⵜ ⵎⴰⵡⴰⵀⵉⴱ ⴰⵍ ⵎⴰⵏⴰⵏ · ⵄⵉⵏ ⵍⵄⵓⴷⴰ", title: "ⴷⴰⵔ ⵍⵇⵔⴰⵏ ⴷ ⵍⵃⴷⵉⵜ", copy: "ⴰⵎⴽⴰⵏ ⵏ ⵜⵖⵔⵉ ⵏ ⵍⵇⵔⴰⵏ ⴷ ⵜⵊⵡⵉⴷ ⴷ ⵙⵙⵓⵏⵏⴰ ⴷ ⵡⴰⵣⴰⵍⵏ ⵉ ⵉⵔⴳⴰⵣⵏ ⴷ ⵜⵍⴰⵡⵉⵏ ⴷ ⵉⴼⵔⵅⴰⵏ ⵙⴳ 5 ⵏ ⵉⵙⴳⴳⴰⵙⵏ.", primary: "ⵜⴰⵍⵖⵓⵜ ⵏ ⵓⵙⵉⵊⵊⵍ", secondary: "ⵙⵙⵏ ⵉⵙⵏⴼⴰⵔⵏ", trust: "ⵜⵖⵔⵉ ⵙ ⵓⵙⵓⴷⵙ · ⵜⵊⵡⵉⴷ · ⵙⵙⵓⵏⵏⴰ" },
