...
export default async function SurahPage({ params }: PageProps) { const item = getSurah((await params).surah); if (!item) notFound(); return <AppShell kind="student"><QuranLearningWorkspace surah={item} /></AppShell>; }
