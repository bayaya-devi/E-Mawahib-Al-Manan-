...
const mutation = z.discriminatedUnion("resource", [
  ...
  z.object({ resource: z.literal("news"), id: z.string().uuid().optional(), status, imageUrl: z.string().url().or(z.literal("")).optional(), eventDate: z.string().date().or(z.literal("")).optional(), translations }),
