(function(){
  ...
  function initNav(){const nav=document.getElementById('admin-nav');requestAnimationFrame(()=>nav.querySelector('.active')?.scrollIntoView({block:'nearest',inline:'center'}));nav.classList.remove('nav-scroll-hidden','is-hidden')}
